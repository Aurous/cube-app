// This file contains the Bluetooth bridge JavaScript as a string
// It's imported and injected into the WebView

export const bluetoothBridgeScript = `
      ...
      gatt: {
        ...
        getPrimaryService: async function(serviceUUID) {
          ...
          sendToNative({
            ...
            id: requestId,
            data: { deviceId: deviceId, serviceUUID: serviceUUID }
          });
    ...
    return {
      ...
      getCharacteristic: async function(characteristicUUID) {
        ...
        sendToNative({
          ...
          id: requestId,
          data: { deviceId: deviceId, serviceUUID: serviceUUID, characteristicUUID: characteristicUUID }
        });
    ...
    return {
      ...
      writeValue: async function(buffer) {
        ...
        sendToNative({
          type: 'writeValue',
          id: requestId,
          data: { deviceId: deviceId, serviceUUID: serviceUUID, characteristicUUID: characteristicUUID, value: base64Value }
        });
